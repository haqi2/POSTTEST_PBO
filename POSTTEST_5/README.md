#  LAPORAN POSTTEST 5 - Wonbee Store PUBGM
...
## 10. Polymorphism
Pada posttest kali ini, saya mengimplementasikan konsep polymorphism pada class AkunPUBGM,AkunGacor,AkunSmurf. yang dimana saya menerapkan 2 tipe statis dan juga dinamis.

Polimorfisme Statis: Saya terapkan pada class AkunPUBGM dalam method setHarga. Di sini terdapat dua method dengan nama sama namun parameter berbeda, yaitu "setHarga" untuk mengubah harga secara langsung dan "setHarga" untuk menghitung harga setelah diskon. dengan menerapkan ini eksekusi pada update data dimenu edit jadi lebih mudah.

Polimorfisme Dinamis: Saya terapkan pada subclass AkunGacor dan AkunSmurf dalam method tampilkanInfo. Di sini terdapat perubahan isi method dari superclass agar dapat menampilkan informasi spesifik, yaitu jumlah "Skin" untuk Akun Gacor dan persentase "Winrate" untuk Akun Smurf. Dengan menerapkan ini, proses memanggil data pada menu daftar akun menjadi lebih otomatis karena program bisa mengenali identitas objek secara mandiri saat berjalan.



## 11. Abstraction
Pada posttest 5 ini, saya menerapkan konsep Abstraction pada class AkunPUBGM sebagai superclass. Penerapannya terbagi menjadi dua bagian utama:

Abstract Class: Saya menerapkan keyword abstract pada class AkunPUBGM. Tujuannya adalah untuk menjadikan class ini sebagai "kontrak" atau template umum yang tidak bisa diinstansiasi menjadi objek secara langsung di class Main. Hal ini menjamin bahwa setiap akun yang masuk ke sistem Wonbee Store harus jelas tipenya, baik itu Akun Gacor maupun Akun Smurf, sehingga menghindari adanya data akun "mentah" yang tidak memiliki spesifikasi jelas.

Abstract Method: Saya membuat method tampilkanInfo() menjadi abstract pada class AkunPUBGM. Method ini tidak memiliki isi di class induk, melainkan hanya memberikan nama method yang wajib ada. Implementasi detailnya ada pada subclass masing-masing. Dengan begini, saya memastikan setiap subclass memiliki tanggung jawab untuk mendefinisikan cara menampilkan informasinya sendiri (Skin/Winrate), namun tetap bisa dipanggil bersamaan melalui referensi superclass.
